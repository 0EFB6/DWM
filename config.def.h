...
/* "monospace:size=15" */
static const char dmenufont[]       = "fontawesome:size=15";
/* "monospace:size=15" */
...
static const char *tags[] = { "Skool", "    Dev     ", "    Fil    ", "    Oce   ", "   Msc   ", "  Wsp   ", "    Dd    ", "   Tty   ", "Misc "};
...
static const char *web[] = { "firefox", NULL }; /* firefox-esr on Debian */
static const char *file[] = { "pcmanfm", NULL };
static const char *dd[] = { "discord", NULL };
static const char *lock[] = { "slock", NULL };
static const char *brave[] = { "brave-browser-stable", NULL }; /*brave on Arch */
